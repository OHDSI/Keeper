...
#' @param sampleSize                 The maximum number of persons to randomly sample from the cohort.
...
#'
#' This contains both the Keeper profiles themselves, as well as some meta-data such as the CDM source name, and cohort
#' prevalence.
#'
#' @export
generateKeeper <- function(connectionDetails = NULL,
  ...
  message(paste0(
    "Generating Keeper profiles took ",
    round(delta, 1),
    " ",
    attr(delta, "units"),
    ". Cohort size is ",
