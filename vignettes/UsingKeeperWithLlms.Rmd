...
```{r echo = FALSE, fig.cap = "Using a reference cohort (a sample of a highly-sensitive cohort) to evaluate cohorts for a phenotype.", out.width = "350px"}
diagramImage <- if (file.exists("Diagram.png")) "Diagram.png" else file.path("vignettes", "Diagram.png")
knitr::include_graphics(normalizePath(diagramImage, mustWork = TRUE), rel_path = FALSE)
```
