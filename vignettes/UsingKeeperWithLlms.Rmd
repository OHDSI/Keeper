...
keeper <- createKeeper(
  ...
  comorbidities = c(
    81893, 201606, 313217, 318800, 432585, 4027663, 4180790, 4212540,
    40481531, 42535737, 46271022
  ),
  drugs = c(
    904453, 906780, 923645, 929887, 948078, 953076, 961047, 985247, 992956,
  ...
  measurements = c(
    3000905, 3000963, 3003458, 3012471, 3016251, 3018677, 3020416,
...
systempPrompt <- createSystemPrompt(
  settings = settings,
...
```{r}
response <- "{\"verdict\": \"Yes\", \"day of onset\": -6}"
```
